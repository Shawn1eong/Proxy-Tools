const $ = new Env('Shawnleong🚗')
const jsname = "Shawnleong🚗";
...
const shareCodes = [
  {
    zd: "olmijoxgmjutzpsfsutvshsemopgexcusbjak2a",
    nc: "1e7f1af959c34e2eb1e5fd7f6c432455",
    mc: "MTAxODc2NTEzMDAwMDAwMDAyNzUzNzI2Mw==",
    dd: "T0225KkcRkse9gXTch79l6EMdQCjVWnYaS5kRrbA",
    jx: "21kTw42DfG_jKmT8ofSlJw==",
    zz: "S5KkcRkse9gXTch79l6EMdQ"
  },
  {
    zd: "olmijoxgmjutzpcz3cvfn7m3nk5izx25jmsr62q",
    nc: "2b30d55798e6440cbfceb5e92ed22c34",
    mc: "MTAxODc2NTEzMDAwMDAwMDAyODg3OTY4Nw==",
    dd: "P04z54XCjVWnYaS5m9cZ2b43ChDxz45ikiSXTA",
    jx: "xuPVc2AP62TPiyGHt4hmig==",
    zz: "S5KkcRh4YoV2FIBPwwPZfJQ"
  },
  {
    zd: "u5lnx42k5ifiunfvo3i2ptusxwne4buyblkruci",
    nc: "d37401264ed1404e8ef9f211e8bb618f",
    mc: "MTE1NDUyMjEwMDAwMDAwMzYwODMzNzM=",
    dd: "T0205KkcJGFzkQGgW3uA0aZcCjVWnYaS5kRrbA",
    jx: "bIrzqjIMsQBao28mVKd6xA==",
    zz: "9L6qWB_cwGMmC0c"
  },
  {
    zd: "66nvo67oyxpyccoglzgwl5usjmtbpvmo7uno5ya",
    nc: "8e20ae3c7a1c4b2a9b4368607914b8b9",
    mc: "MTE1NDQ5OTUwMDAwMDAwNDI3NzQ0NDM=",
    dd: "T0205KkcN3l7oSauQFq-9J52CjVWnYaS5kRrbA",
    jx: "jNZkHBEDJTnBCbEoGYdsyw==",
    zz: "S5KkcN3l7oSauQFq-9J52"
  },
...
async function showMsg() {
  if ($.isNode()){
     $.log(jsname+'\n'+message)
     await notify.sendNotify("Shawnleong🚗", message)
    }else{
     $.log(message)
     $.msg(jsname, "", message)
 }
