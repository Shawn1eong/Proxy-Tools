...
[Script]
WPS_checkin = type=cron,cronexp=0 8 * * *,wake-system=1,timeout=120,debug=1,script-path=WPS_checkin.js,argument="AK=百度key&SK=百度key&MAX_RETRIES=5"
...
const { AK, SK, DAY = 1, MAX_RETRIES = 5 } = $.parseArgument();
