...
母婴有机日 好物超值购
2021-9-11 ~ 2021-9-13
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/4473153?activityId=e7fe51d43cd845cd85f8be756192c74c&shareUuid=857beeeadb5e423aa677559b89a14528
*/
const $ = new Env("母婴有机日 好物超值购");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityId = 'e7fe51d43cd845cd85f8be756192c74c'
            $.activityShopId = '1000002520'
            $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/${$.authorNum}?activityId=${$.activityId}&shareUuid=857beeeadb5e423aa677559b89a14528&adsource=null&shareuserid4minipg=null&shopid=${$.activityShopId}&lng=00.000000&lat=00.000000&sid=&un_area=`
            await marry();
            if ($.bean > 0) {
...
async function marry() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            if ($.index === 1) {
                await task('dz/openCard/activityContent', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&pinImg=&nick=${encodeURIComponent($.pin)}&cjyxPin=&cjhyPin=&shareUuid=857beeeadb5e423aa677559b89a14528`, 0, 1)
            } else {
                await task('dz/openCard/activityContent', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&pinImg=&nick=${encodeURIComponent($.pin)}&cjyxPin=&cjhyPin=&shareUuid=857beeeadb5e423aa677559b89a14528`)
            }
