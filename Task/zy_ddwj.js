...
var taskid,token,helpcode,secretp;
...
list2tokenArr.push(list3.shoppingActivityVos[i].taskToken)
       ...
       for(let i = 0; i < list4.browseShopVo.length; i ++){
...
//$.log(list5.followShopVo[i].taskToken)
       ...
       for(let i = 0; i < list7.shoppingActivityVos.length; i ++){listtokenArr.push(7+list7.shoppingActivityVos[i].taskToken)
list2tokenArr.push(list7.shoppingActivityVos[i].taskToken)
//$.log(list5.followShopVo[i].taskToken)
       }
       let list8 = result.data.result.taskVos.find(item => item.taskId == 8)
       for(let i = 0; i < list8.shoppingActivityVos.length; i ++){listtokenArr.push(8+list8.shoppingActivityVos[i].taskToken)
...
//$.log(list5.followShopVo[i].taskToken)
      ...
      let list13 = result.data.result.taskVos.find(item => item.taskId == 13)
       for(let i = 0; i < list13.followShopVo.length; i ++){listtokenArr.push(13+list13.followShopVo[i].taskToken)
list2tokenArr.push(list13.followShopVo[i].taskToken)
//$.log(list5.followShopVo[i].taskToken)
       }
       let list14 = result.data.result.taskVos.find(item => item.taskId == 14)
       for(let i = 0; i < list14.shoppingActivityVos.length; i ++){listtokenArr.push(14+list14.shoppingActivityVos[i].taskToken)
list2tokenArr.push(list14.shoppingActivityVos[i].taskToken)
//$.log(list5.followShopVo[i].taskToken)
       }
       let list15 = result.data.result.taskVos.find(item => item.taskId == 15)
       for(let i = 0; i < list15.shoppingActivityVos.length; i ++){listtokenArr.push(15+list15.shoppingActivityVos[i].taskToken)
list2tokenArr.push(list15.shoppingActivityVos[i].taskToken)
//$.log(list5.followShopVo[i].taskToken)
       }
       let list16 = result.data.result.taskVos.find(item => item.taskId == 16)
       for(let i = 0; i < list16.shoppingActivityVos.length; i ++){listtokenArr.push(16+list16.shoppingActivityVos[i].taskToken)
...
let list5 = result.data.result.taskVos.find(item => item.taskId == 5)
       for(let i = 0; i < list5.assistTaskDetailVo.length; i ++){listtokenArr.push(5+list5.assistTaskDetailVo[i].taskToken)
list2tokenArr.push(list5.assistTaskDetailVo[i].taskToken)
//$.log(list5.followShopVo[i].taskToken)
       }
